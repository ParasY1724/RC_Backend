    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_question', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='rc_app.question')),
            ],
        ),
        migrations.CreateModel(
            name='Team',
        ...
        migrations.AddField(
            model_name='progress',
            name='team',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='progress', to='rc_app.team'),
        ),
        migrations.DeleteModel(
            name='TeamTable',
        ),
